...
- DONE render summary of mock event correctly
- DONE render information of event
- DONE render information of mock event correctly
- DONE render button to show details
- Done do not render details by default
- DONE render details when show details button is clicked
- DONE render title, link, and description when details are visible
- DONE der button to hide details when details are visible
- DONE do not render details when hide details button is clicked
*/
...
describe('<Event /> component', () => {
  ...
  test('render title, link, and description when details are visible', () => {
  ...
  test('render button to hide details when details are visible', () => {
    EventWrapper.setState({detailsVisible: true });
